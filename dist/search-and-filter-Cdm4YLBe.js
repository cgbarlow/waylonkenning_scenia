const e = `# Search and Filter

![Global search](../../public/features/global-search.png)
...
**Tip**: use search to quickly locate a specific initiative when the portfolio is large, then click through to the timeline view to see it in context.

---

- Previous: [CSV Paste](csv-paste.md)
- Next: [Resource Roster](../08-resources/resource-roster.md)
`;
export {
  e as default
};
